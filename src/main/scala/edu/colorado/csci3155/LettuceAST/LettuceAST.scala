...
case class FunDef(paramList: List[String], e: Expr) extends Expr
/* Function call */
case class FunCall(e: Expr, argList: List[Expr]) extends Expr

/* Recursive Definition */
case class LetRec(f: String, fd: FunDef, e2: Expr) extends Expr
